...
def SVMKFolds(feature_set, label_set):
	...
	print("SVM's accuracy with K Folds strategy: ", accuracy)

def SVMLeaveOneOut(feature_set, label_set):
	loo = LeaveOneOut()
	correct = 0
	...
	accuracy = correct/len(feature_set)
	print("SVM's accuracy with Leave One Out strategy: ", accuracy)
...
def main(dataset_name):
	...
	SVMLeaveOneOut(feature_set, label_set)
	SVMKFolds(feature_set, label_set)
